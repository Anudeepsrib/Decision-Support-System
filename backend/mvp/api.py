...
from backend.mvp.extractor import extract_tables_from_pdf, get_page_count
from backend.mvp.normalizer import normalize_row_label
from backend.mvp.comparison import run_comparison, calculate_variance, classify_decision
from backend.mvp.prompts import generate_variance_explanation
...
async def generate_order(
    ...
    from backend.mvp.pdf_generator import generate_order_pdf, WEASYPRINT_AVAILABLE
